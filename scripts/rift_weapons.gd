...
const TABLE := {
	RIFLE: {
		...
		"optic_tip_local": Vector3(0.0, 0.262, -0.22), "ads_anchor": Vector3(0.0, -0.09956, -0.82),
	...
	SMG: {
		...
		"optic_tip_local": Vector3(0.0, 0.232, -0.18), "ads_anchor": Vector3(0.0, -0.08816, -0.76),
	...
	SHOTGUN: {
		...
		"optic_tip_local": Vector3(0.0, 0.185, -0.50), "ads_anchor": Vector3(0.0, -0.07030, -0.82),
	...
	PISTOL: {
		...
		"optic_tip_local": Vector3(0.0, 0.152, -0.08), "ads_anchor": Vector3(0.0, -0.05776, -0.62),
	...
	SNIPER: {
		...
		"optic_tip_local": Vector3(0.0, 0.190, -0.40), "ads_anchor": Vector3(0.0, -0.07220, -0.80),
